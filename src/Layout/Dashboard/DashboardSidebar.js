...
import { GoOrganization, GoVerified } from 'react-icons/go';
import { MdChangeCircle, MdGroups, MdStore } from 'react-icons/md';
    ...
    const handleImageUpdate = (e) => {
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                axios.put(`https://phonex.vercel.app/upload-profile?email=${user?.email}&profile=${image}`, {
                })
                    .then(res => {
