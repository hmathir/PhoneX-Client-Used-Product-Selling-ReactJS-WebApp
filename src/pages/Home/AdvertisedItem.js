    ...
    return (
        ...
        <div className="my-5 py-5 bg-gray-200 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-3">
                ...
                <article class="rounded-xl border-4 border-white ">
                    <div class="flex items-start p-6">
                        <Link href="#" class="block shrink-0">
                            <img
                                alt="Speaker"
                        ...
                        <div class="ml-4">
                            ...
                            <div class="mt-2 sm:flex sm:items-center sm:gap-2">
                                ...
                                <p class="hidden sm:block sm:text-xs sm:text-gray-500">
                                    Posted by
                                    <Link href="#" class="font-medium underline hover:text-gray-700">
                                        John
                                    </Link>
                                </p>
                            </div>
                    ...
                    <div class="flex justify-end">
                        <strong
                            class="-mr-[2px] -mb-[2px] inline-flex items-center gap-1 rounded-tl-xl rounded-br-xl bg-yellow-600 py-1.5 px-3 text-white"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4"
                            ...
                            <span class="text-[10px] font-medium sm:text-xs">Ad</span>
                        </strong>
                    </div>
                </article>
                <article class="rounded-xl border-4 border-white ">
